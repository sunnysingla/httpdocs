...
public partial class Manage_TutorDetail : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static List<string> UpdateTutorInfo(string Name,string Address, string Email, string Password, string Phone,string SPhone, string Avail, string TutorId,string Subjects, 
    string MondayOpen,
    ...
    string FridayClose, string SaturdayOpen, string SaturdayClose, string SundayOpen, string SundayClose)
    {
        ...
        string tblUpdateMessage = Manage_TutorDetail.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> LogTransferRequest(string Date, string StartTime, string Endtime, string Message, string TutorId)
    {
        ...
        string tblUpdateMessage = Manage_TutorDetail.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
        string tblRequestLogged = Manage_TutorDetail.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[1]);
    ...
    public static List<string> GetTutor(string TutorId)
    {
        ...
        string tblTutor = Manage_TutorDetail.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
        string tblTutorList = Manage_TutorDetail.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[1]);
        string tblInbox = Manage_TutorDetail.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[2]);
        string tblSend = Manage_TutorDetail.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[3]);
        string tblSubjects = Manage_TutorDetail.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[4]);
