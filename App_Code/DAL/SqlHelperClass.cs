...
using System.Text;
    ...
    public sealed class SqlHelper
    {
        ...
        public static readonly string conString = ConfigurationManager.ConnectionStrings["TutoringClub"].ConnectionString;
        ...
        public static void FillDataTable(SqlConnection connection, CommandType commandType,
           ...
           params SqlParameter[] commandParameters)
        {
            FillDataTable(connection, null, commandType, commandText, datatable, tableNames, commandParameters);
        }
           ...
           params SqlParameter[] commandParameters)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                FillDataTable(connection, commandType, commandText, datatable, tableNames, commandParameters);
            }
        }
