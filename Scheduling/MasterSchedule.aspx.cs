...
public partial class Scheduling_MasterSchedule : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static List<string> CheckOverRide(string Date)
    {
        ...
        PM[1] = new SqlParameter("@Date", SqlDbType.VarChar);
        PM[1].Value = Date;
    ...
    [WebMethod]
    public static List<string> CheckOverRideFrm_to(string from, string to)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_CheckOverRide_from_to", dsResult, null);
        string SucessMsg = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    [WebMethod]
    public static List<string> Schedular_Date(string Date)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_Schedular_Date", dsResult, null);
        string SucessMsg = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> MasterScheduling(string Time, string Day, string Date)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_MasterScheduling", dsResult, null);
        string tblTables = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
        string tblTutor = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[1]);
        string tblStudent = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[2]);
        string tblStudent_SH = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[3]);

        List<string> obj_list = new List<string>();
        obj_list.Add(tblTables);
        obj_list.Add(tblTutor);
        obj_list.Add(tblStudent);
        obj_list.Add(tblStudent_SH);
        return obj_list;
    }
    [WebMethod]
    public static List<string> DeleteStudent(string ID)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_DeleteStudent", dsResult, null);
    ...
    public static List<string> DeleteTutor(string ID1, string ID2, string ID3)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_DeleteTutor", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    [WebMethod]
    public static List<string> MasterSchedule_ADD_UpdateDayTime(string Day, string Time, string TutorID, string StudentID, string SubjectID, string ID, string Tablenumber)
    {
        DataSet dsResult = new DataSet();
        DataFunctions df = new DataFunctions();
        GenralFunction gf = new GenralFunction();
    ...
    public static List<string> DeleteTble(string ID)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_DeleteTble", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    [WebMethod]
    public static List<string> Swipe_Student_BlankMSID_Summary(string MasterScheduleID1, string MasterScheduleID2,
    string TableNumber, string Day, string Time)
    {
        DataSet dsResult = new DataSet();
        DataFunctions df = new DataFunctions();
        GenralFunction gf = new GenralFunction();
        ...
        PM[0].Value = MasterScheduleID1;

        PM[1] = new SqlParameter("@MasterScheduleID2", SqlDbType.VarChar);
        PM[1].Value = MasterScheduleID2;

        PM[2] = new SqlParameter("@TableNumber", SqlDbType.VarChar);
        PM[2].Value = TableNumber;
        PM[3] = new SqlParameter("@Day", SqlDbType.VarChar);
        PM[3].Value = Day;
        PM[4] = new SqlParameter("@Time", SqlDbType.VarChar);
        PM[4].Value = Time;

        dsResult = gf.Filldatasetvalue(PM, "Swipe_Student_BlankMSID_Summary", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> Swipe_Student(string ID1, string ID2)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "Swipe_Student", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> Swipe_Student_BlankMSID(string ID1, string Tablenumber)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "Swipe_Student_BlankMSID", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> Swipe_Tutor(string SID1, string SID2, string SID3 , string TID1, string TID2, string TID3)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_SwipeTutor", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> GetSubject()
    {
        ...
        string tblSubjects = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> UpdateSubject(string Subject, String MasterScheduleId)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_UpdateSubject", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    [WebMethod]
    public static List<string> UpdateTable(String Tables)
    {
        DataSet dsResult = new DataSet();
        DataFunctions df = new DataFunctions();
        GenralFunction gf = new GenralFunction();
        ...
        PM[0].Value = HttpContext.Current.Session["FranchiseID"].ToString();
        PM[1] = new SqlParameter("@Tables", SqlDbType.BigInt);
        PM[1].Value = Tables;

        dsResult = gf.Filldatasetvalue(PM, "USP_UpdateTable", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> MasterSchedule_ADD_Update_Tutor(string TutorID, string ID1, string ID2, string ID3, string Tablenumber)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_MasterSchedule_ADD_Update_Tutor", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    [WebMethod]
    public static List<string> MasterSchedule_ADD_Update_Tutor_All(string TutorID, string ID1, string ID2, string ID3, string Tablenumber,string TimeID,string Day)
    {
        DataSet dsResult = new DataSet();
        DataFunctions df = new DataFunctions();
        GenralFunction gf = new GenralFunction();
    ...
    [WebMethod]
    public static List<string> MasterSchedule_ADD_Update_TutorDayTime(string Day, string Time, string TutorID, string ID1, string ID2, string ID3, string Tablenumber)
    {
        DataSet dsResult = new DataSet();
        DataFunctions df = new DataFunctions();
        GenralFunction gf = new GenralFunction();
    ...
    public static List<string> UpdateTableNumber(string MSID1, string MSID2, string MSID3, string Tablenumber)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "USP_UpdateTableNumber", dsResult, null);
        string tblMessage = Scheduling_MasterSchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
