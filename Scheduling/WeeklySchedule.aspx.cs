...
public partial class Scheduling_WeeklySchedule : System.Web.UI.Page
{
    ...
    public static List<string> MasterScheduling(string Time, string Day, string Date)
    {
        ...
        string tblTables = Scheduling_WeeklySchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
        string tblTutor = Scheduling_WeeklySchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[1]);
        string tblStudent = Scheduling_WeeklySchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[2]);
        string tblStudent_SH = Scheduling_WeeklySchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[3]);

        string tblStudent_AB = Scheduling_WeeklySchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[4]);
...
string TableNumber, string Day, string Time)
    {
        ...
        dsResult = gf.Filldatasetvalue(PM, "Swipe_Student_BlankMSID_Session_Summary", dsResult, null);
        string tblMessage = Scheduling_WeeklySchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
    ...
    public static List<string> GetSubject()
    {
        ...
        string tblSubjects = Scheduling_WeeklySchedule.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
