...
public partial class Enrollment_MasterTC : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (Session["Role"].ToString() == "3")
        {
            if (Request.Url.ToString().ToLower().IndexOf("highpriority.aspx") < 0)
            {
                ...
                {
                    string tblNotes = Enrollment_MasterTC.DataTableToJSONWithJavaScriptSerializer(dsResult.Tables[0]);
